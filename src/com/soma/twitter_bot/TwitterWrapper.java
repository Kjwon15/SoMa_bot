...
public class TwitterWrapper extends Observable{
	...
	public TwitterWrapper(String consumer_key, String consumer_secret, String access_token, String access_secret) {
			...
			for (User user : followers) {
				if (followings.contains(user) == false) {
					try {
						...
						sb.append(String.format("New user: \"%s\" Failed (%s)\n",
	...
	public void replyTo(Status status, String answer) {
		...
		String msg = String.format("@%s %s", status.getUser().getScreenName(), answer);
